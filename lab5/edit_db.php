        ...
        <div class="row mt-5 ">
            <div class="col-6 display-4">
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" value="<?=$arr[0]['name']?>"></div>
                <div class="form-group">
                    <label for="surname" class="btn-outline-dark  font-weight-bold " style="font-size: 22px">Фамилия</label>
                    <input type="text" name="surname" id="surname" class="form-control" value="<?=$arr[0]['surname']?>">
                </div>
                <div class="form-group">
                    <label for="lastname" class="btn-outline-dark  font-weight-bold " style="font-size: 22px">Отчество</label>
                    <input type="text" name="lastname" id="lastname" class="form-control" value="<?=$arr[0]['lastname']?>">
                </div>


                <div class="form-group">
                    <label for="birthday" class="btn-outline-dark  font-weight-bold " style="font-size: 22px"> Дата рождения</label>
                    <input type="date" name="birthday" id="birthday" class="form-control" value="<?=$arr[0]['birthday']?>">
                </div>
                <div class="form-group">
                    <label for="inn" class="btn-outline-dark  font-weight-bold " style="font-size: 22px">ИИН</label>
                    <input type="text" name="inn" id="inn" class="form-control" value="<?=$arr[0]['inn']?>"></div>
                <div class="form-group">
